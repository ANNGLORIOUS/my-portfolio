      ...
      <section id="AboutMe" className="about--section">
        ...
        <div className="hero--section--content--box about--section--box">
          <div className="hero--section--content">
            ...
            <br /> When I’m not coding, you can find me reading books, which inspires my creativity and keeps me motivated. I look forward to connecting and exploring how I can add value to your team!
            </p>
          </div>
        </div>
      </section>
